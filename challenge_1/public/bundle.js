...
function (_Component) {
  ...
  _createClass(App, [{
    key: "fetchDataByDate",
    value: function fetchDataByDate(date, offset, limit) {
      var _this2 = this;

      return fetch("/events?date=".concat(date, "&_page=").concat(Math.floor(offset / limit) + 1, "&_limit=").concat(limit)).then(function (res) {
        _this2.total = Number.parseInt(res.headers.get(TOTAL), 10);
        return res.json();
      });
    }
  }, {
    key: "fetchDataByText",
    value: function fetchDataByText(text, offset, limit) {
      var _this3 = this;

      return fetch("/events?q=".concat(text, "&_page=").concat(Math.floor(offset / limit) + 1, "&_limit=").concat(limit)).then(function (res) {
        _this3.total = Number.parseInt(res.headers.get(TOTAL), 10);
        return res.json();
      });
    }
  }, {
    key: "makeRequest",
    value: function makeRequest(mode, offset, limit) {
      var _this4 = this;

      var promise = mode === DESCRIPTION ? this.fetchDataByText(this.query, offset, limit) : this.fetchDataByDate(this.query, offset, limit);
    ...
    value: function handlePageClick(data) {
      ...
      var offset = Math.ceil(selected * ITEMS_PER_PAGE);
      this.makeRequest(mode, offset, ITEMS_PER_PAGE);
    }
  }, {
    key: "onTypeChange",
    value: function onTypeChange(mode) {
      this.setState({
        mode: mode
      });
    }
    ...
    value: function render() {
      ...
      return _react2["default"].createElement("div", null, _react2["default"].createElement("div", {
        ...
        type: "button",
        className: "search",
        onClick: this.onTypeChange.bind(this, YEAR)
      }, "Search By Year"), _react2["default"].createElement("button", {
        type: "button",
        className: "search",
        onClick: this.onTypeChange.bind(this, DESCRIPTION)
      }, "Search By Description"), _react2["default"].createElement("input", {
        type: "text",
        className: "search",
        placeholder: mode ? 'Search by text...' : 'Search by year...',
        ...
        id: "eventList"
      }, events.length > 0 ? _react2["default"].createElement("div", null, _react2["default"].createElement("ul", null, events.map(function (obj) {
        return _react2["default"].createElement("li", {
          className: "eventItem"
        }, _react2["default"].createElement("p", null, obj.date), _react2["default"].createElement("p", null, obj.description));
      ...
      }))) : _react2["default"].createElement("h3", null, "Historical events will show up here!")));
    }
  }]);
...
_reactDom2["default"].render(_react2["default"].createElement(_App2["default"], null), document.getElementById('react-paginate'));
